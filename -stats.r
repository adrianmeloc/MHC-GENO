...
#line28:reads files each file based on the pattern of the name, this has to be adjusted according to...
#		the names of the samples used.
#line29:creates a list that contains a value of 1% of total number of sequences. This value can be
#		adjusted. For example if we want a 5% threshold we can change the ".01" to ".05"
